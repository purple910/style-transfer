...
flags.DEFINE_string('path_style', "./style/png", 'Row style images path')
flags.DEFINE_string('path_content', "E:\\python\\val2014", 'Row style images path')
# flags.DEFINE_string('path_content', "E:\\python\\train2014", 'Row style images path')

flags.DEFINE_string('record_style_name', 'styles.tfrecords', 'Style tfrecord name')
flags.DEFINE_string('record_dataset_name', 'val2014.tfrecords', 'Data set tfrecord name')
# flags.DEFINE_string('record_dataset_name', 'train2014.tfrecords', 'Data set tfrecord name')
...
def read_content_tfrecord(path_tfrecord, image_size):
    ...
    # 解码图片数据 tf.decode_raw用于将字符串转换成unit8的张量
