...
def main(FLAGS):
    ...
    style_features_t = losses.get_style_features(FLAGS, training_path)
    ...
    with tf.Graph().as_default():
        with tf.Session() as sess:
            ...
            #                                 train_image_path, image_preprocessing_fn, epochs=FLAGS.epoch)
            processed_images = reader.image(FLAGS.batch_size, FLAGS.image_size, FLAGS.image_size,
                                            FLAGS.train_img, image_preprocessing_fn, epochs=FLAGS.epoch)
